...
decimal		["64bit floating point number (IEEE standard)" scalar] ; 2.2250738585072014 × 10^−308 to 1.7976931348623157 × 10^308
...
integer		["64 bit integer" scalar] ; −9,223,372,036,854,775,807 to +9,223,372,036,854,775,807
...
tuple		["sequence of small integers (colors, versions, IP)" scalar] ; −32767 to +32767
